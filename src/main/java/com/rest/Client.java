 ...
 * <p/>
 * Created by ShiYun on 2015/11/16 0016.
 */
public class Client {
...
//        parameters.put("wd","vgXueNt7");
//        parameters.put("un","Product");
//        parameters.put("time","2016-08-01-08");
//        parameters.put("mac","60ACC8010B32");
//        String result = sendPost("https://114.112.99.139/apiworks/v1/status/routerScan", parameters);
        String logs = postNetSecurityLogs("https://114.112.99.139/apiworks/v1/status/routerScan?sign=1446808653Product&un=Product&time=2016-08-01-08&wd=vgXueNt7&mac=60ACC8010B32", "utf-8");
        System.out.println(logs);
        JSONArray data = new JSONArray();
        JSONObject jsonObject = JSONObject.fromObject(logs);
        data = jsonObject.getJSONArray("data");
        for (int i = 0; i < data.size(); i++) {
            JSONObject one = data.getJSONObject(i);
            String date = one.getString("scanTime");
            System.out.println(date);
            String mac = one.getString("scanMac");
